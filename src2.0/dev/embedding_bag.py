...
CHUNK_FILE = "data/processed/budget_at_a_glance_chunks_para750.json"
COLLECTION_NAME = "budget_at_a_glance_para_750"
...
ids = [f"baag_para750_{i:04d}" for i in range(len(chunks))]
metadatas = [{
    "source": "budget_at_a_glance",
